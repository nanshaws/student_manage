;(function ($) {
    var methods = {
        ...
        pageData: function (_v, _current) {
            ...
            var t = opts.totalData, ajaxOpts = null;
        ...
        dataRender: function (_v, _data) {
            ...
            for (var d of _data) {
                ...
                $trTemp.append("<td style='border: 1px solid #d0d0d0;color: #404060;'>" + d.duty + "</td>");
                ...
                $trTemp.append("<td style='border: 1px solid #d0d0d0;color: #404060;'>" +
                    "<input class='btn btn-primary btn-sm' type='button' value='修改' onclick='showTeacherEditModal(" + d.id + ")'>" +
                    "<input class='btn btn-danger btn-sm' type='button' value='删除' onclick='deleteTeacherInfo(" + d.id + ")'></td>");
